...
- fix SQLite volume permissions (#21)
...
- add version command and update bot presence

### Changed

- include bot version on ready
...
- fix bot invite link (#7)

## [0.9.0] - 2026-06-01

### Added

- add landing page for zentrynel (#4)
